...
from .data import COCO_KEYPOINTS, COCO_SIGMAS, COCO_SKELETON, data_category


from .evaluation import COCOeval, COCO
...
class EvalCoco(object):
    def __init__(self, coco, processor, keypoint_sets_inverse, skeleton=None):
        ...
        self.keypoint_sets_inverse = keypoint_sets_inverse #? Maybe here 
    ...
    def stats(self, predictions=None, image_ids=None):
        ...
        #!CAR
        cat_ids = self.coco.getCatIds(catNms=[data_category])
        coco_eval = self.coco.loadRes(predictions)

        #TODO MODIFY THE EVLAUATION
        self.eval = COCOeval(self.coco, coco_eval, iouType='keypoints',sigmas=COCO_SIGMAS)
