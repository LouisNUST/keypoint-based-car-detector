...
from .data import data_category
from . import transforms, utils



ANNOTATIONS_TRAIN = '/data/bonnesoeur-data/carfusion_to_coco/annotations/car_train0.3.json'
ANNOTATIONS_VAL = '/data/bonnesoeur-data/carfusion_to_coco/annotations/car_test0.3.json'
IMAGE_DIR_TRAIN = '/data/bonnesoeurbonnesoeur-data/data/carfusion/train'
...
class CocoKeypoints(torch.utils.data.Dataset):
    ...
    def __init__(self, root, annFile, *, target_transforms=None,
        ...
        self.cat_ids = self.coco.getCatIds(catNms=[data_category])
        if all_images:
    ...
    def __getitem__(self, index):
        ...
        print(image_info)
        if 'flickr_url' in image_info and image_info['flickr_url']!= 'unknown':            
