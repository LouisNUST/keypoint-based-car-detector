...
def main():
    ...
    if args.augmentation:
        preprocess_transformations = [
            ...
            #transforms.RescaleRelative(scale_range=(0.5 * args.rescale_images, 1.0 * args.rescale_images)),
            transforms.RescaleRelative(scale_range=(0.8 * args.rescale_images, 1.1 * args.rescale_images)),
