...
def factory_from_args(args):
    ...
    if not args.checkpoint:
        args.checkpoint = '/home/maximebonnesoeur/semester_project/openpifpaf/outputs/resnet50-pif-paf-skeleton-edge700-191113-211113-446e20cd.pkl'#'resnet152'  # Default model Resnet 152
    # glob
    if not args.webcam:
        if args.glob:
