...
class PreprocessNuscenes:
    ...
    def __init__(self, dir_ann, dir_nuscenes, dataset, iou_min):
        ...
        self.dir_nuscenes  = dir_nuscenes
        dir_out = dir_ann+"/../out"# os.path.join('data', 'arrays')
        ...
        for ii, scene in enumerate(self.scenes):
            ...
            while not current_token == "":
                ...
                for cam in self.CAMERAS:
                    ...
                    currentFolder = os.path.join(os.path.join(self.dir_nuscenes,"samples"),cam)
                    ...
                    if exists:
                        ...
                        #TODO 
                        pil_img = PIL.Image.open(os.path.join(currentFolder, name))
